...
export function CompanyCard({
  ...
  return (
    <Link
      ...
      className={cn(
        "group flex cursor-pointer flex-col rounded-2xl border border-border bg-surface p-4 sm:p-6",
      ...
      <div className="flex flex-1 flex-col gap-5">
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            {company.location ? (
              <p className="mt-0.5 flex min-w-0 items-center gap-1 text-xs uppercase tracking-wide text-muted-foreground">
